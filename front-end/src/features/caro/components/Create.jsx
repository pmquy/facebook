...
export default function () {
  ...
  return <div>
    {open && <div onClick={e => {if(!ref.current.contains(e.target)) setOpen(false)}} className='fixed z-20 top-0 left-0 w-screen h-screen bg-black_trans'>
      <div ref={ref} className='card absolute left-1/2 top-1/2 max-h-screen overflow-y-auto  max-sm:w-full -translate-x-1/2 -translate-y-1/2 p-5 flex flex-col gap-5'>
