...
export default function () {
  ...
  return <div className="z-10 fixed w-full top-0 flex justify-between p-2 bg-white_1 border-b-2">
    ...
    <div className="flex gap-2 basis-1/3 justify-end">
      ...
      <div className="p-2 rounded-full hover:bg-white_0 relative group">
        <div className=" absolute w-max p-2 right-0 bottom-0 hidden group-hover:block rounded-lg bg-red_0 text-white_0 translate-y-[150%]">Account</div>
