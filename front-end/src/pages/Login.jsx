  ...
  return <div>
    ...
    <div style={{ background: 'linear-gradient(to left top, #222831, #00ADB5)' }}>
      <div ref={s1} className=" content-center bg-cover bg-center bg-no-repeat min-h-screen p-10">
        <div ref={pRef1} className="flex gap-20 max-xl:flex-col opacity-0 overflow-x-hidden duration-1000 transition-all card dark:card-black justify-center p-10 items-center">
